package com.example.rememberwell.alarm;
...
import com.example.rememberwell.ui.PortadaActivity;
...
public class NotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent2) {
        ...
        Intent mIntent = new Intent(this, PortadaActivity.class);
        Resources res = this.getResources();
        Uri soundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALARM);

        String message = "Toca para abrir la aplicación";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle("¿Qué tal estuvo tu día?").setCategory(Notification.CATEGORY_SERVICE)
